  ...
  return (
    <Drawer>
      ...
      <DrawerContent className="p-4">
        <DrawerHeader className="from-bg-secondary absolute inset-x-10 top-0 z-10 flex items-center justify-center gap-4 bg-gradient-to-b from-70% to-transparent p-4">
