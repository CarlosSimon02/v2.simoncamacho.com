...
<MDXContentWrapper>
  ...
  <TitleContent title="Lessons Learned">
    ...
    <br />
    State management was another challenge. A shopping cart, product filters,
    and user sessions all had to stay in sync. That’s where
    [Zustand](https://docs.pmnd.rs/zustand/getting-started/introduction) came
    in. Its simple API made complex state feel manageable, and it gave me
    confidence to scale features without the usual headaches.
    <br />
